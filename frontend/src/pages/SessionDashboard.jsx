...
import { Plus, Play, LogOut, Calendar, Users, ChevronRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#06402B] p-6 lg:p-10 relative">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="bg-[#134E4A] rounded-2xl p-6 shadow-xl border-2 border-[#06402B]">
                    <h2 className="text-xl pixel-font text-[#FFD700] mb-6">Past Expeditions</h2>
                            ...
                            {sessions.map((s, i) => (
                                ...
                                >
                                    <div className="flex-1">
                                        <h3 className="font-bold text-[#F4E8D1] text-lg">{s.title}</h3>
